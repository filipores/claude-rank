...
Gamify your Claude Code usage. Track XP, level up, earn achievements, and maintain streaks — all from your terminal.
...
- **10 Achievements** — Common to Legendary rarity
...
- **Claude Code Status Line** — See your rank while you code
- **SessionStart Hook** — Claude knows your level
...
# First sync — parses your Claude Code data
claude-rank sync
```
...
- [ ] **Auto-sync via hooks** — PostToolUse hook to track XP in real-time
- [ ] **More achievements** — 20+ additional achievements (Code Surgeon, Zero Defect, The Inception...)
- [ ] **Prestige system** — Reset at Level 50 with permanent star badges
- [ ] **GitHub README badge** — Dynamic SVG showing your rank
- [ ] **"Claude Code Wrapped"** — Monthly/yearly stats summary
- [ ] **MCP Server** — Claude can query your stats mid-conversation
